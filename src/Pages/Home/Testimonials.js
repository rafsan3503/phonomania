        ...
        <div className="lg:-mx-6 lg:flex lg:items-center">
          ...
          <div className="mt-8 lg:w-1/2 lg:px-6 lg:mt-0">
            ...
            <p className="max-w-lg mt-6 text-gray-500 dark:text-gray-400 ">
              “ Phonomania is a great site to find the technology devices for my
              business. Every purchase that i have made has been a easy reliable
              transaction that makes finding what you need a simple task.
              Because of the past transactions that have been perfect, i trust
              their seller ratings without hesitation. Thanks Phonomania for
            ...
            <p className="text-gray-600 dark:text-gray-300">Retailer</p>
