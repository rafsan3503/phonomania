  ...
  return (
    <section class="bg-white dark:bg-gray-900">
      <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form class="w-full max-w-md" onSubmit={handleSignup}>
          <img
          ...
          <select
            class="flex items-center px-3 py-3 mx-auto mt-6 text-center bg-white border-2 w-full rounded-md cursor-pointer"
            name="role"
            required
          >
